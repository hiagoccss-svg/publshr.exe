...
| **Chat sidebar** | 272px fixed · **#FFFFFF** | Search in unified titlebar row; filters, lists, footer (flat, no boxed chrome) |
| **Main column** | flex · **#FFFFFF** | Unified titlebar icons align with columns 1–2; messages + composer |
