...
| Shell | `MainIDEView.swift`, `ShellUnifiedTitlebar`, `TrafficLightLayoutStore` (measured traffic lights), `LibraryBarMenuColumn` (~20% width), `AppSecondarySidebar` (272pt universal submenu) |
